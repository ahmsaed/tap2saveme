 ...
 />
        ...
        <View style={styles.contentContainer}>
          <View style={styles.formContainer}>
            ...
            <Text style={[styles.subtitle, isDarkMode &&styles.allText]}>Welcome! Please Enter Login Details</Text>
          ...
          <TouchableOpacity style={styles.buttonWrapper} onPress={handleContinue}>
            {
              isDarkMode ? (
                <View style={[styles.continueButton, { backgroundColor: '#FFFFFF' }]}>
                  <Text style={[styles.continueButtonText, {color:'#5939C2'}]}>Login</Text>
                </View>
              ) : (
                <LinearGradient
